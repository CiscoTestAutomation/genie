...
.. csv-table:: New Module Versions
    ...
    ``genie``, v26.5 
    ``genie.lamp``, v26.5 
    ``genie.libs.health``, v26.5 
    ``genie.libs.clean``, v26.5 
    ``genie.libs.conf``, v26.5 
    ``genie.libs.filetransferutils``, v26.5 
    ``genie.libs.ops``, v26.5 
    ``genie.libs.parser``, v26.5 
    ``genie.libs.robot``, v26.5 
    ``genie.libs.sdk``, v26.5 
    ``genie.telemetry``, v26.5 
...
* genie/harness/discovery.py
    * Added ``section_results`` support for retry decorator
        * When ``section_results=["passed"]`` is specified, tests are retried on pass to gauge stability by repeating N times and verifying all N iterations pass
